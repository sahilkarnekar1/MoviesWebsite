...
mysqli_query($con,"INSERT INTO `movies`(`Name`, `Description`, `Link480`, `Link720`, `Link1080`, `Bannerimage`, `Screenshot1`, `Screenshot2`, `Screenshot3`, `Categories`,`WebEp`) VALUES ('$moviename','$description','$link1','$link2','$link3','$img_name','$ss1_name','$ss2_name','$ss3_name','$categories','$webEp')");
